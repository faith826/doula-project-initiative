        ...
        <nav className="flex text-sm text-charcoal/60" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                <ChevronRight className="w-4 h-4 mx-1" />
                <span className="text-charcoal font-medium">Postpartum Support</span>
              </div>
            </li>
          </ol>
        </nav>
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Mother and newborn baby receiving postpartum care" 
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/90 leading-relaxed max-w-2xl mx-auto mb-8">
              Gentle, nurturing care to help you recover, bond with your baby, and adjust to the fourth trimester.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 max-w-4xl mx-auto">
        ...
        >
          <p className="text-xl text-charcoal/80 leading-relaxed mb-12 text-center">
            The postpartum period is a time of profound physical and emotional transition. Our doulas "mother the mother", providing holistic support to ensure your family thrives during these precious early weeks.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <p className="text-charcoal/70">
                We prioritize your healing by encouraging rest, preparing nourishing meals, and providing physical comfort measures as your body recovers from birth.
              </p>
            </div>
            <div>
              <h3 className="text-2xl font-bold font-heading text-teal mb-4 flex items-center gap-2">
              ...
              <p className="text-charcoal/70">
                Whether you choose to breastfeed, pump, or formula feed, we offer evidence-based guidance, positioning tips, and reassurance to help you establish a routine.
              </p>
            </div>
            <div>
              <h3 className="text-2xl font-bold font-heading text-teal mb-4 flex items-center gap-2">
              ...
              <p className="text-charcoal/70">
                We assist with soothing techniques, diapering, bathing, and babywearing, building your confidence in caring for your new baby.
              </p>
            </div>
            <div>
              <h3 className="text-2xl font-bold font-heading text-teal mb-4 flex items-center gap-2">
              ...
              <p className="text-charcoal/70">
                We provide a safe space to process your birth experience, listen to your concerns, and help identify signs of postpartum mood disorders if professional help is needed.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="bg-teal text-white rounded-[2rem] p-12 shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contact" className="bg-coral text-white px-8 py-4 rounded-lg font-semibold hover:bg-coral/90 transition-colors inline-flex items-center justify-center gap-2 shadow-sm">
              Request Postpartum Support <ArrowRight className="w-5 h-5" />
            </Link>
